...
<body class="bg-white h-screen">
    <div class="w-full flex flex-wrap">
            ...
            <div class="flex flex-col justify-center md:justify-start my-auto pt-8 md:pt-0 px-8 md:px-24 lg:px-32">
                ...
                <form class="flex flex-col pt-3 md:pt-8" action="" method="post">
                    <div class="flex flex-col pt-4">
                        ...
                        <input type="text" id="email" placeholder="email@gmail.com" class="shadow appearance-none border rounded w-full py-2 text-gray-700 mt-1 leading-tight focus:outline-none border-b-4 border-gray-300 focus:border-blue-600 transition duration-500 px-3 pb-3">
                    </div>
                    <div class="flex flex-col pt-4">
                ...
                <div class="text-center pt-12 pb-12">
                    <p>Already have an account? <a href="LoginPage.html" class="underline font-semibold">Log in here.</a></p>
                </div>
            </div>
        </div>
        ...
        <div class="w-1/2 shadow-2xl">
            ...
            <img class="object-cover w-full h-screen hidden md:block" src="/assets/image/Humanitarian Help-rafiki.svg" alt=""></div>
    </div>
</body>
